$('#send').click(
    function () {
        ...
        var url = "https://crossorigin.me/https://food2fork.com/api/search?key=315107456e4b02d7abecd295c694c6e6&q=" + list;
...
$(document).keypress(function (e) {
    if (e.which == 13) {
        ...
        if(listsearch === ""){
            var url = "https://crossorigin.me/https://food2fork.com/api/search?key=315107456e4b02d7abecd295c694c6e6&q=" + listsearch1;
        }else{
             var url = "https://crossorigin.me/https://food2fork.com/api/search?key=315107456e4b02d7abecd295c694c6e6&q=" + listsearch;
        }
        $.getJSON(url, function (data) {
            if (data.recipes.length === 0) {
