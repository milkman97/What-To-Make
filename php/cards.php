...
<div class="row">
    <div class="col s12 m4">
        <div class="card animated slideInUp">
            ...
            <div class="card-reveal">
                ...
                <h5 id="publisher1"></h5>
                <p><a href="#" target="_blank" id="publisherurl4">Visit Them!</a></p>
                <h6 id="rank4"></h6>
            </div>
        </div>
    </div>
    <div class="col s12 m4">
        <div class="card animated slideInUp">
            ...
            <div class="card-reveal">
                <span class="card-title grey-text text-darken-4" id="title5"><i class="mdi-navigation-close right"></i></span>
                <h5 id="publisher2"></h5>
                <p><a href="#" target="_blank" id="publisherurl5">Visit Them!</a></p>
                <h6 id="rank5"></h6>
            </div>
        </div>
    </div>
    <div class="col s12 m4">
        <div class="card animated slideInUp">
            ...
            <div class="card-reveal">
                ...
                <h5 id="publisher3"></h5>
                <p><a href="#" target="_blank" id="publisherurl6">Visit Them!</a></p>
                <h6 id="rank6"></h6>
            </div>
        </div>
    </div>
